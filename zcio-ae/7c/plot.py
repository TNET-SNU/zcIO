#!/usr/bin/env python3
# plot.py (fig-7c) — grouped BAR chart of steady NVMe/TCP read throughput vs
...
def main():
    ...
    ap.add_argument("--title", default="NVMe/TCP read throughput vs block size (stream5 1-core)")
    args = ap.parse_args()
