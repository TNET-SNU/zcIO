...
# Sourced by sweep-unet3d.sh, so all_in_one.sh / _fast.sh / _zc6.sh all pick it up.
...
CORES="${CORES:-1 2 4 6 8 10}"       # online-core sweep points (the _fast/_zc6 wrappers override this)
