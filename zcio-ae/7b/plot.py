#!/usr/bin/env python3
# plot.py (fig-7b) — line chart of steady NVMe/TCP random-WRITE TX throughput vs rapids0 core
...
def main():
    ...
    ap.add_argument("--title", default="NVMe/TCP 256k random write vs rapids0 cores")
    args = ap.parse_args()
